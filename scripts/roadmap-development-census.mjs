...
console.log(JSON.stringify({
  ...
  intakeAuthorityClosure: {
    ...
    recovery: "Original app/generation/lineage and public definition; immutable request before effect, exact receipt replay, per-ID future save/publish exclusion. Does not relabel, delete or revoke a still-active form",
  ...
  opfsRecoveryDevelopment: {
    ...
    remaining: "Catalog-proven unopened tuple, physical exclusion/preflight before first catalog read, exact lifecycle/restore ordering, poison/reopen and all-target strict canonical/catalog readback; guard unchanged",
  },
  developmentBlockers: [
    ...
    { phase: "F", kind: "code", boundary: "Private legacy intake state/historical receipt and unbound old sharing-receipt adoption remain unimplemented; originals/export denial preserved. Original-custody V2 cache-only closure/revoke recovery and explicit stale-revoke renewal are now connected. Missing original custody/app/generation remains quarantined; stale authority-closure invocation still needs explicit reviewed terminal renewal, not retargeting." },
  ],
