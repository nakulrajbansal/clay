...
const entries = [
  ...
  ["B", "Manual download records", ["recordManualBackupDownload", "manualBackupDownloads"], ui("RecoveryCenter.tsx"), test("worker-restore-integration.test.ts"), "Authority journal and unverified external-save wording connected; presentation reload/revalidation recovery remains"],
