...
const GRANT_KEYS = [
  "schema", "kind", "validationId", "archiveFormat", "checksumAuthenticated",
  "archiveSha256", "archiveTarget", "preservedAppInstanceId", "destinationAppInstanceId",
  "installMode", "validatedAt",
] as const;
const TARGET_KEYS = [
...
export function parseAuthenticatedFormat5RestoreGrant(
  ...
  if (!target
      ...
      || grant.checksumAuthenticated !== true
