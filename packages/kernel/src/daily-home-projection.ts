import { OperationalViewLibrary } from "@clay/schema/standalone/saved-views";
import {
...
type OperationalViewValue = ReturnType<typeof OperationalViewLibrary.parse>["views"][number];
