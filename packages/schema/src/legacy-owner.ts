...
export const LegacyOwnerRouteV1 = z.enum(["intake.saveForm", "intake.markPublished", "intake.revokeForm", "intake.markExpired", "intake.command"]);
export const LegacyOwnerCandidateV1 = z.object({ schema: z.literal(1), authorityIncarnationId: AuthorityIncarnationId,
...
export const LegacyOwnerProofV1 = LegacyOwnerCandidateV1.innerType().extend({ kind: z.enum(["intake_private", "intake_public"]),
...
export const LegacyOwnerInventoryV1 = z.object({ schema: z.literal(1), target: TargetEvidenceV1,
