...
export const IntakeOwnerClaimV1 = z.object({ schema: z.literal(1), requestId: RequestId,
...
export const IntakeOwnerWitnessV1 = z.object({ schema: z.literal(1), status: z.enum(["live", "history_only", "deleted"]),
