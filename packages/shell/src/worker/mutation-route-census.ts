...
export const DB_WORKER_ROUTE_CENSUS = Object.freeze({
  ...
  activateStarter: route("authority", "live"),
  activateImportedApp: route("authority", "live"),
  firstRunPublication: route("read", "none"),
  undoFirstRunImport: route("authority", "live"),
  firstRunEvidence: route("read", "none"),
  firstEverydayActionTarget: route("read", "none"),
  completeEverydayAction: route("authority", "live"),
  updateRecordWithSampleHandoff: route("authority", "live"),
...
export const CLAY_STORE_WRITER_CENSUS = Object.freeze({
  ...
  promoteSampleRowProvenance: "authority",
