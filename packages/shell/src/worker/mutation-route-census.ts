...
export const DB_WORKER_ROUTE_CENSUS = Object.freeze({
  ...
  saveIntakeForm: route("unavailable", "none"),
  markIntakeFormPublished: route("unavailable", "none"),
  revokeIntakeForm: route("unavailable", "none"),
  markIntakeFormExpired: route("unavailable", "none"),
  stageIntakeSubmission: route("unavailable", "none"),
  recordIntakeDeliveryFailure: route("unavailable", "none"),
  authorizeIntakeDeliveryDiscard: route("unavailable", "none"),
  resolveIntakeDeliveryFailure: route("unavailable", "none"),
  rejectIntakeSubmission: route("unavailable", "none"),
  simulateIntakeAutoAccept: route("unavailable", "none"),
  enableIntakeAutoAccept: route("unavailable", "none"),
  disableIntakeAutoAccept: route("unavailable", "none"),
  processIntakeAutoAccept: route("unavailable", "none"),
  acceptIntakeSubmission: route("unavailable", "none"),
  undoIntakeReceipt: route("unavailable", "none"),
  ...
  mutationOutcome: route("read", "none"),
  cancelPresentation: route("authority", "lifecycle"),
  presentationSource: route("read", "none"),
  convertTextToRelation: route("authority", "live"),
  undoRelationConversion: route("authority", "live"),
  ...
  backupRetentionPlan: route("read", "none"),
  backupRetentionHistory: route("read", "none"),
  authorizeBackupRemoval: route("authority", "lifecycle"),
  acknowledgeBackupRemoval: route("authority", "lifecycle"),
  manualBackupDownloads: route("read", "none"),
  manualBackupDownloadOutcome: route("read", "none"),
  validateManualBackupDownload: route("read", "none"),
...
export const RETIRED_DB_WORKER_ROUTES = Object.freeze({
  saveIntakeForm: "Retired direct intake writer; use source-bound intakeCommand with a retained explicit request.",
  markIntakeFormPublished: "Retired direct intake writer; use source-bound intakeCommand with a retained explicit request.",
  revokeIntakeForm: "Retired direct intake writer; use source-bound intakeCommand with a retained explicit request.",
  markIntakeFormExpired: "Retired direct intake writer; use source-bound intakeCommand with a retained explicit request.",
  stageIntakeSubmission: "Retired direct intake writer; use source-bound intakeCommand with a retained explicit request.",
  recordIntakeDeliveryFailure: "Retired direct intake writer; use source-bound intakeCommand with a retained explicit request.",
  authorizeIntakeDeliveryDiscard: "Retired direct intake writer; use source-bound intakeCommand with a retained explicit request.",
  resolveIntakeDeliveryFailure: "Retired direct intake writer; use source-bound intakeCommand with a retained explicit request.",
  rejectIntakeSubmission: "Retired direct intake writer; use source-bound intakeCommand with a retained explicit request.",
  simulateIntakeAutoAccept: "Retired direct intake writer; use source-bound intakeCommand with a retained explicit request.",
  enableIntakeAutoAccept: "Retired direct intake writer; use source-bound intakeCommand with a retained explicit request.",
  disableIntakeAutoAccept: "Retired direct intake writer; use source-bound intakeCommand with a retained explicit request.",
  processIntakeAutoAccept: "Retired direct intake writer; use source-bound intakeCommand with a retained explicit request.",
  acceptIntakeSubmission: "Retired direct intake writer; use source-bound intakeCommand with a retained explicit request.",
  undoIntakeReceipt: "Retired direct intake writer; use source-bound intakeCommand with a retained explicit request.",
