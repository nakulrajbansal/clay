...
export const DB_WORKER_ROUTE_CENSUS = Object.freeze({
  ...
  backupTrustStatus: route("read", "none"),
  beginBackupTrustEnrollment: route("ephemeral", "none"),
  confirmBackupTrustEnrollment: route("device-trust", "lifecycle"),
  importRecoveryKit: route("device-trust", "lifecycle"),
  activateImportedBackupSeries: route("device-trust", "lifecycle"),
  backupSelection: route("read", "none"),
  prepareAutomaticBackup: route("device-trust", "lifecycle"),
  validateBackupStage: route("read", "none"),
  publishBackup: route("authority", "lifecycle"),
  backupRecords: route("read", "none"),
  validateRestoreArchive: route("read", "none"),
  restoreAsNew: route("authority", "lifecycle"),
  exportArchive: route("device-trust", "lifecycle"),
