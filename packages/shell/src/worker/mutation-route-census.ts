...
export const DB_WORKER_ROUTE_CENSUS = Object.freeze({
  ...
  createApp: route("authority", "lifecycle"),
  forkApp: route("authority", "lifecycle"),
  switchApp: route("authority", "lifecycle"),
  renameApp: route("authority", "lifecycle"),
  deleteApp: route("authority", "lifecycle"),
  ...
  reset: route("authority", "lifecycle"),
